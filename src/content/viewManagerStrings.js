(() => {
    ...
    class ViewManagerStrings {
        ...
        static defaultEnglish = {
            ...
            openCustomEditor: "Open Custom Prompt Editor",
            ...
            addNotes: "Add notes",
            editOrDeleteNotes: "Edit or delete notes",
            minimiseHoverToolbar: "Minimise hover toolbar",
            ...
            customEditorTitle: "Prompt Editor",
            customEditorPromptLabel: "ChatGPT Prompt",
            customEditorPromptPlaceholder: "Type your prompt here...",
            customEditorGoToPrompt: "Go to prompt composer",
            customEditorMaximiseDialog: "Maximise Prompt Editor",
            customEditorRestoreDialog: "Restore Prompt Editor",
            customEditorCloseDialog: "Close Prompt Editor",
            customEditorClear: "Clear",
            customEditorCleared: "Prompt editor cleared.",
            customEditorClearedForPageChange: "Prompt editor cleared because the ChatGPT page changed.",
            customEditorSetPrompt: "Set Prompt",
            customEditorSetPromptAndSend: "Set Prompt & Send",
            ...
            customEditorPromptSetButSendNotClicked: "Prompt was set, but the send button was not found or was disabled after retries.",
