...
* [ ] Content script loads on `https://chatgpt.com/*`.
* [ ] CSS is injected correctly.
* [ ] No runtime errors appear in the browser console on page load.
* [ ] No design-time errors appear in VS Code.
* [ ] Reloading the extension and refreshing ChatGPT restores expected behaviour.
* [ ] Extension does not interfere with normal ChatGPT interaction.
* [ ] Extension handles ChatGPT single-page navigation between conversations.

## 2. Floating View Manager Overlay

* [ ] Overlay appears on ChatGPT pages.
* [ ] Overlay position is usable and does not block important page content.
* [ ] Overlay can be collapsed.
* [ ] Overlay can be expanded again.
* [ ] Collapsed/expanded overlay state persists globally.
* [ ] Overlay header/title displays correctly.
* [ ] Overlay status shows detected block count.
* [ ] Overlay remains responsive in long conversations.
* [ ] Overlay layout remains compact at normal browser zoom.
* [ ] Overlay layout remains usable at increased zoom.
* [ ] Overlay does not lose state after page refresh.

## 3. Toolbar Actions

* [ ] Bookmark visible block button works.
* [ ] Collapse highlighted block button works.
* [ ] Restore all collapsed blocks button works.
* [ ] Rescan conversation blocks button works.
* [ ] Scroll to top button works.
* [ ] More dropdown opens.
* [ ] More dropdown closes on outside click.
* [ ] More dropdown closes on Escape.
* [ ] More dropdown actions remain accessible after repeated overlay renders.
* [ ] Toolbar icons have useful tooltips.
* [ ] Toolbar icons have useful `aria-label` values.
* [ ] Toolbar remains visually compact.
* [ ] Toolbar does not wrap awkwardly.

## 4. Block Detection

* [ ] Conversation blocks are detected.
* [ ] User blocks are detected.
